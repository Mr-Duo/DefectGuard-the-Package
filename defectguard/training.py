...
def load_dataset(file_path, hyperparameters, code_dict, msg_dict):
    ...
    for data_point in yield_jsonl(file_path):
        ...
        codes.append(padding_data(data=padding_data_point["code_change"].split("\n"), dictionary=code_dict, params=hyperparameters, type='code'))
        messages.append(padding_data(data=padding_data_point["messages"], dictionary=msg_dict, params=hyperparameters, type='msg'))
