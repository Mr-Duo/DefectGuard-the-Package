...
mkdir focal_loss/SETUP1/ros focal_loss/SETUP2/ros focal_loss/SETUP3/ros focal_loss/SETUP4/ros focal_loss/SETUP5/ros
...
python3 -m defectguard.cli training  \
    ...
    -dg_save_folder focal_loss/SETUP1/ros \
    -repo_name FFmpeg \
    -device cuda \
    -repo_language C  \
    -epoch 30
...
python3 -m defectguard.cli training  \
    ...
    -dg_save_folder focal_loss/SETUP2/ros \
    -repo_name FFmpeg \
    -device cuda \
    -repo_language C \
    -epoch 30
...
python3 -m defectguard.cli training  \
    ...
    -dictionary "dataset/FFmpeg/SETUP2/dict-FFmpeg.jsonl" \
    -dg_save_folder focal_loss/SETUP3/ros \
    -repo_name FFmpeg \
    -device cuda \
    -repo_language C \
    -epoch 30
...
python -m defectguard.cli training  \
    ...
    -dictionary "dataset/FFmpeg/SETUP2/dict-FFmpeg.jsonl" \
    -dg_save_folder focal_loss/SETUP4/ros \
    -repo_name FFmpeg \
    -device cuda \
    -repo_language C \
    -epoch 30
...
python -m defectguard.cli training  \
    ...
    -dictionary "dataset/FFmpeg/SETUP2/dict-FFmpeg.jsonl" \
    -dg_save_folder focal_loss/SETUP5/ros \
    -repo_name FFmpeg \
    -device cuda \
    -repo_language C \
    -epoch 30
