...
mkdir SETUP1/rus SETUP2/rus SETUP3/rus SETUP4/rus SETUP5/rus
...
python3 -m defectguard.cli training  \
    ...
    -commit_train_set "dataset/FFmpeg/SETUP4/rus/SETUP4-FFmpeg-deepjit-train.jsonl" \
...
python3 -m defectguard.cli training  \
    ...
    -commit_train_set "dataset/FFmpeg/SETUP5/rus/SETUP5-FFmpeg-deepjit-train.jsonl" \
